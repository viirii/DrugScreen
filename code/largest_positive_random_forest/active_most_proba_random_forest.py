...
def active_most_proba_random_forest(difficulty='EASY', num_init_label=500):
    ...
    while np.sum(selected_mask) < 2500:
        ...
        random_forest_f1_score = f1_score(y_test, predictions)
...
if __name__ == '__main__':
    if len(sys.argv) == 1:
        active_most_proba_random_forest(difficulty='EASY', num_init_label=500)
    else:
